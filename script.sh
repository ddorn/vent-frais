...
function generate() {
        ...
        cache_dir="pdfs/vent-frais-s$scale-d$density/"
        ...
        ./cards.py pdf -o "$pdf_file" "$deck_file" --cache-dir "$cache_dir"
...
generate 10 0 data/questions-23-05-16.csv 12 show
# generate 10 40 data/questions-23-05-16.csv 12 show
